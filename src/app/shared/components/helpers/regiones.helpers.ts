...
export class RegionesHelpers{
    RegionesYcomunas: { regiones: { NombreRegion: string; comunas: string[] }[] } = { regiones: [] };

    regiones(){
    this.RegionesYcomunas = {
            ...
            },
            {
                ...
                "comunas": ["Cobquecura", "Coelemu", "Ninhue", "Portezuelo", "Quirihue", "Ránquil", "Trehuaco", "Bulnes", "Chillán Viejo", "Chillán", "El Carmen", "Pemuco", "Pinto", "Quillón", "San Ignacio", "San Nicolás", "Coihueco", "Ñiquén", "San Carlos", "San Fabián", "Yungay"]
            }
            ,{
        ...
        return of(this.RegionesYcomunas);
    }
}