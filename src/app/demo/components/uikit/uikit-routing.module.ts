...
import { CalendarioReservasComponent } from './formlayout/calendario-reservas/calendario-reservas.component';
import { FormLayoutDemoComponent } from './formlayout/formlayoutdemo.component';
import { MainReservasComponent } from './formlayout/main-reservas/main-reservas.component';
...
@NgModule({
    ...
    imports: [RouterModule.forChild([
       ...
       // { path: 'calendario-reservas', data: { breadcrumb: 'Gestion reservas 2' }, loadChildren: () => import('./gestion-reservas/reservas.module').then(m => m.ReservasModule) },
